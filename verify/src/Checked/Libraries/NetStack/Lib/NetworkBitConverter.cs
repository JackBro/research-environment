...
using System;
using Bytes = Microsoft.Singularity.Bytes;
...
namespace Drivers.Net
{
    ...
    public sealed class NetworkBitConverter
    {
        ...
        public static ushort ToUInt16(Bytes value, int startIndex)
        {
            return ByteOrder.BigEndianToHost(
                BitConverter.ToUInt16(value.Array, value.Start + startIndex)
                );
        }
        ...
        public static uint ToUInt32(Bytes value, int startIndex)
        {
            return ByteOrder.BigEndianToHost(
                BitConverter.ToUInt32(value.Array, value.Start + startIndex)
                );
        }
