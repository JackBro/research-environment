...
namespace System.Extensions.CodeDom.Collections
{
	...
	public class ConstructorDeclarationCollection: System.Collections.CollectionBase
	{
		...
		/// </param>
		public void AddRange(ConstructorDeclaration[] items)
		{
		...
		/// </param>
		public void Add(ConstructorDeclaration value)
		{
			this.List.Add(value);
		}
		...
		/// false otherwise.
		/// </returns>
		public bool Contains(ConstructorDeclaration value)
		{
		...
		/// -1 otherwise.
		/// </returns>
		public int IndexOf(ConstructorDeclaration value)
		{
		...
		/// </param>
		public void Insert(int index, ConstructorDeclaration value)
		{
		...
		/// </summary>
		public  ConstructorDeclaration this[int index]
		{
			get
			{
