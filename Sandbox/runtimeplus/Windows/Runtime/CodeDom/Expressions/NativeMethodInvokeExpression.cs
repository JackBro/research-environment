...
namespace System.Extensions.CodeDom.Expressions
{
	...
	{
		private NativeMethodReferenceExpression invokedMethod;
		private ExpressionCollection parameters = new ExpressionCollection();

		public NativeMethodInvokeExpression(
			NativeMethodReferenceExpression method,
		...
		public NativeMethodReferenceExpression InvokedMethod
		{
			get
			{
		...
		public override CodeExpression ToCodeDom()
		{
			return new CodeMethodInvokeExpression(
				this.invokedMethod.Target.ToCodeDom(),
				this.InvokedMethod.Name,
