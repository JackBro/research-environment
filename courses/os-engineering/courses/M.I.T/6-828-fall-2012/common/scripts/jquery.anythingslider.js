	...
	$.anythingSlider = function(el, options) {
		...
		base.init = function(){
			...
			$(doc).keyup(function(e){
				...
				if (o.enableKeyboard && base.$wrapper.hasClass('activeSlider') && !e.target.tagName.match('TEXTAREA|INPUT|SELECT') && !$('#carousel_inner:hover').length) {
