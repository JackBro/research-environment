...
$('a.poplight').click(function() {
    ...
    $('#' + popID).fadeIn().css({ 'width': Number( popWidth ) }).prepend('<a href="#" class="close"><img src="/images/close.png" class="video_popup_btn_close" title="Close Window" alt="Close" /></a>');
...
function set_jwplayer_options(container_id, media_url, provider, page_url, image_url, start, stop, captions_file){
    ...
    var sharing_params =    {   link: 'http://ocw.mit.edu' + page_url,
