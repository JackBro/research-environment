...
function updateProformaWarningVisible(checkBox,dropDownId,labelId)
{
    if(checkBox.checked)
    {
        //see if O or L is the selected value
        debugger;
...
function updateProformaWarningVisible(checkBoxId,dropDownId,labelId)
{
    ...
    if(checkBox.checked)
    {
        ...
        if(dropDown.value=="O" || dropDown.value=="L")
        {
            value = '';   
        }
    }
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFAZmPjPSRwaj
// SIG // KwgHrSH70+7Z8T9YoIISMTCCBGAwggNMoAMCAQICCi6r
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBQzTYo4Le3x
// SIG // sEj/4bMI3YI0erE/+TBeBgorBgEEAYI3AgEMMVAwTqAm
// SIG // gCQATQBpAGMAcgBvAHMAbwBmAHQAIABMAGUAYQByAG4A
// SIG // aQBuAGehJIAiaHR0cDovL3d3dy5taWNyb3NvZnQuY29t
// SIG // L2xlYXJuaW5nIDANBgkqhkiG9w0BAQEFAASCAQCxoi1c
// SIG // ok2BNx5cN+w1G4Sab9dpYQsYGHSA3EiTr84JO9WNcyMk
// SIG // Sm/v1VOGe4TaAoMoair8DdQluEFzUFHtEbJw8sBFdUyC
// SIG // LjmHaYOqVdZvZJ95nvQSgAIGEDNpOug7HWEPPbPjSE75
// SIG // pZdORumg5jpg0fch3KjQ+09+nZLPQjRBkbcuH6gDsoTz
// SIG // Q6607jUjDTdgBGvaH51p4Dg7mqu4G9ktgX0hpO9x2+DQ
// SIG // qoZezdJ0jUP5R4GJEhWrpy8uxzdUgmbN9wx+cefgezm/
// SIG // rbKJ63sjWQnL+qESsNpoxa1tPzTWpe/Xi5RW8Qyx/QR3
// SIG // DybbV2Yj5+wvFjV4T8DCkumAfmnCoYICHzCCAhsGCSqG
...
// SIG // hkiG9w0BCQUxDxcNMDgxMjA5MjAwMjE5WjAjBgkqhkiG
// SIG // 9w0BCQQxFgQUDySV7c8Sf5JEx9HFmJtSIDTcDJ0wDQYJ
// SIG // KoZIhvcNAQEFBQAEggEAxQ5chQ1YLhQ3Jo/Ost5zpChH
// SIG // cq0VTpo66aUvIMp74qCJ1jCPHm2PJvex1PiQOr0pKPUs
// SIG // WUaAbhvtJ1CAfr0WBALIJq927F2RcI4Dcgmug19W7sWa
// SIG // oLEdzZjSVHydrWSDgg89v27awCTOdcrZUheoHk/vyOzF
// SIG // eMY4Xj8ONyqws1PFRz01BehIuKYuK2D8dfOm7hpRLVVH
// SIG // SboYR+Wo/fY7wX6OVj7GD54UoMlePBGid7GlhSi5e5nC
// SIG // B/rA8vSBuFc3w/fcwCrfbB43r19eEYEJDI8gubSEwUct
// SIG // tciUCOqhiSFWm6xgGeXmfXQ1agNILrLXWIDKygcil0/+
// SIG // 2bGQyYsV3w==
