...
(function () {
	var jscriptToVerify = WScript.StdIn.ReadAll();
	WScript.StdOut.WriteLine('****************************************');
	if (!JSLINT(jscriptToVerify, {passfail: false})) {
	
	    WScript.StdErr.WriteLine('Script: ==============================================');
	    WScript.StdErr.WriteLine(jscriptToVerify);
		...
		for (var i=0; i < JSLINT.errors.length; i++ ) {
			...
			var errorDetail = getErrorMessageFor(e) || 'no error details!';
			WScript.StdErr.WriteLine(errorDetail);
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFG+2XQMgkUx5
// SIG // bsZv3nzVHZl3iY7YoIISJDCCBGAwggNMoAMCAQICCi6r
...
// SIG // KoZIhvcNAQkEMRYEFG/h+Vp11ZASGRD0j17EDJY9eaz2
...
// SIG // CSqGSIb3DQEBAQUABIIBAJnTHd/zbxPJgF+nMlAl4ozJ
// SIG // tor7Z9Nam1bDNUjBYcQTUhMPZOoEcRYOKka/Z3QsGtSd
// SIG // PLC7sFmp9T1jK1FtV2QnBVnZg2pn0psA6BfpC0MuqlJ6
// SIG // KYBOQiBlDEEQNQ7O3TtxOcpumOHMJPTMsMwUhevgIF2c
// SIG // Hi+SFFOZZQZNYWYQ6h+rfgJ5FsCbTe+2Jz4wFOtIksJn
// SIG // N2jR7jdlqnU9dt7vReBpkmRVjldDDR2w42nJyI5VgmOI
// SIG // 4ecwzrB30dxTmX40WKo60c22PdSNaBku+YzoqLYYRX/q
// SIG // SL0CjWEFo/sU1GxYXHbi9fJ7FshnMfH0+XanJ65J+pgy
// SIG // r9T6LB1bn9GhggIfMIICGwYJKoZIhvcNAQkGMYICDDCC
...
// SIG // ODEyMDkyMDAyMTlaMCMGCSqGSIb3DQEJBDEWBBSG6LuQ
// SIG // ZwarWzgB3HOdiT12mc2m9TANBgkqhkiG9w0BAQUFAASC
// SIG // AQAir8PQtwRd5UnxAooXaSUqVm9cr8LunyFI9SsrL2C8
// SIG // NJ9Gk6osqRlyMITIzEapnIZuYS7t57y+S8YZuqHodqUc
// SIG // a37ZwWqhyn4qXrvCIiUsGNWAWeI1z/pVt9bJwAUpawJ1
// SIG // gYGsR8CHPchea6Ul4VAh9d8Z1OembJcfWiS8GW0mfobU
// SIG // BhL+NFg1667P/foQ+xdJQ7LyCvLVSbzeaidypL07g+io
// SIG // WZOLa1CYACd2VZP7nVwqS7TKIimYnAwOyqFZs9jWJsWi
// SIG // f/LFcekhf3RH/wxT0Wp3mIBfRk9/oOOiUwmAQuxSoX/Y
// SIG // Vqv1SMbxgODFEUBbiPWz9ODifpT4QKs34SZM
