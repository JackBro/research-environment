...
namespace nslookup
{
	...
	///			multiple IP Ranges.
	///		</description>
	///		<author>Jonathan Moore</author>
	///		<version>1.0</version>
	///		<date>March 23 2006</date>
	///		
	/// </summary>
	class NSLookup
	{
		...
		static int Main(string[] args)
		{
			...
			else
			{
				...
				try
				{
					...
					var alpha = "aAbBcCdDeEfFgGhHiIjJkKlLmMnNoOpPqQrRsStTuUvVwWxXyYzZ-".ToCharArray();
					...
					if (args[0].IndexOfAny(alpha) != -1)
					{
						...
						for (i = 0; i < len; i++)
						{
							Console.WriteLine ("Address {0} : {1} ", i, ipAddr[i]);
						}
