...
namespace System.Extensions.CodeDom.Collections
{
	...
	public CatchClauseCollection(CatchClause[] items)
		...
		/// </param>
		public void AddRange(CatchClause[] items)
		{
		...
		/// </param>
		public void Add(CatchClause value)
		{
			this.List.Add(value);
		}
		...
		/// false otherwise.
		/// </returns>
		public  bool Contains(CatchClause value)
		{
		...
		{
            readonly System.Collections.IEnumerator wrapped;
