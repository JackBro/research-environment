...
namespace System.Extensions.CodeDom.Collections
{
	...
	public class EventDeclarationCollection: System.Collections.CollectionBase
	{
		...
		/// </param>
		public void AddRange(EventDeclaration[] items)
		{
		...
		/// </param>
		public void Add(EventDeclaration value)
		{
			this.List.Add(value);
		}
		...
		/// false otherwise.
		/// </returns>
		public bool Contains(EventDeclaration value)
		{
		...
		/// -1 otherwise.
		/// </returns>
		public int IndexOf(EventDeclaration value)
		{
		...
		/// </param>
		public void Insert(int index, EventDeclaration value)
		{
		...
		/// </summary>
		public EventDeclaration this[int index]
		{
			get
			{
				return (EventDeclaration)List[index];
			}
			set
			{
                List[index] = value;
		...
		public class Enumerator: System.Collections.IEnumerator
		{
			...
			public EventDeclaration Current
			{
				get
				{
					return (EventDeclaration) (wrapped.Current);
				}
			}
