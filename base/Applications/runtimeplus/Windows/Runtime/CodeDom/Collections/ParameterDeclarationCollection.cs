...
namespace System.Extensions.CodeDom.Collections
{
	...
	public class ParameterDeclarationCollection: System.Collections.CollectionBase
	{
		...
		/// </param>
		public void AddRange(ParameterDeclaration[] items)
		{
		...
		/// </param>
		public void AddRange(ParameterDeclarationCollection items)
		{
			foreach (ParameterDeclaration item in items)
			{
                List.Add(item);
		...
		/// </param>
		public virtual void Add(ParameterDeclaration value)
		{
            List.Add(value);
		}
