...
namespace System.Extensions.CodeDom.Collections
{
	...
	public class FieldDeclarationCollection: System.Collections.CollectionBase
	{
		...
		/// </param>
		public void AddRange(FieldDeclaration[] items)
		{
		...
		/// </param>
		public void AddRange(FieldDeclarationCollection items)
		{
			foreach (FieldDeclaration item in items)
			{
                List.Add(item);
		...
		public virtual FieldDeclaration this[int index]
		{
			get
			{
				return (FieldDeclaration)List[index];
			}
			set
			{
                List[index] = value;
		...
		public class Enumerator: System.Collections.IEnumerator
		{
			...
			public FieldDeclaration Current
			{
				get
				{
					return (FieldDeclaration) (wrapped.Current);
				}
			}
