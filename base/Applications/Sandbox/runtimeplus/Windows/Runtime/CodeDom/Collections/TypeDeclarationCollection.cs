...
namespace System.Extensions.CodeDom.Collections
{
	...
	public class TypeDeclarationCollection: System.Collections.CollectionBase
	{
		...
		/// </param>
		public void AddRange(ITypeDeclaration[] items)
		{
		...
		/// </param>
		public void Add(ITypeDeclaration value)
		{
            List.Add(value);
		}
		...
		{
            List.Add(new TypeTypeDeclaration(value));
		}
		...
		public virtual ITypeDeclaration this[int index]
		{
			get
			{
				return (ITypeDeclaration)List[index];
			}
			set
			{
                List[index] = value;
		...
		public class Enumerator: System.Collections.IEnumerator
		{
			...
			public ITypeDeclaration Current
			{
				get
				{
					return (ITypeDeclaration) (wrapped.Current);
				}
			}
