...
namespace System.Extensions.CodeDom.Collections
{
	...
	public class PropertyDeclarationCollection: System.Collections.CollectionBase
	{
		...
		/// </param>
		public void AddRange(PropertyDeclaration[] items)
		{
		...
		/// false otherwise.
		/// </returns>
		public bool Contains(PropertyDeclaration value)
		{
		...
		/// -1 otherwise.
		/// </returns>
		public int IndexOf(PropertyDeclaration value)
		{
		...
		/// </param>
		public void Insert(int index, PropertyDeclaration value)
		{
		...
		/// </summary>
		public PropertyDeclaration this[int index]
		{
			get
			{
				return (PropertyDeclaration)List[index];
			}
			set
			{
                List[index] = value;
		...
		/// </param>
		public void Remove(PropertyDeclaration value)
		{
            List.Remove(value);
		}
